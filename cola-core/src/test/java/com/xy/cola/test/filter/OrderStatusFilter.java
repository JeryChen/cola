...
public class OrderStatusFilter implements Filter<OrderPlaceCmd> {

    private static final Logger logger = LoggerFactory.getLogger(OrderStatusFilter.class);
